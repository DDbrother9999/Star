...
public class Yaml {
    ...
    public long getOrDefault(String path, long def) {
        return this.yaml.getLong(path, def);
    }
    public int getOrDefault(String path, int def) {
    ...
    public boolean getOrDefault(String path, boolean def) {
        return this.yaml.getBoolean(path, def);
    }

    public double getOrDefault(String path, double def) {
